...
Daphnia <- readDNAStringSet("Daphnia_fetch.fasta")
...
Daphniacluster_comp <- hclust(dist(Daphniadist), method = "complete")
plot(Daphniacluster)


#MA: ------------ Maverick's additions ---------------

#MA: Creating a distance based cluster for MSA data with the single-linkage method
